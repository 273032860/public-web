...
import video1first from '../imgs/video2end.jpeg'



//纹理导入
var texture = new THREE.TextureLoader().load(video1first);
...
vec3 curlNoise( vec3 p ){
  ...
  return normalize( vec3( x , y , z ) * divisor );
    ...
    void main() {
      ...
      vec4 mvPosition = modelViewMatrix * vec4(finalPosition, 1.0); //固定position 改finalPosition
