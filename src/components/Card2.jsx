...
function Card2({ items2 }) {
  return (
    <div className="p-4 w-auto   rounded-lg border shadow-md sm:p-6 dark:bg-gray-800 dark:border-gray-700 mt-14 bg-white/30    bg-clip-padding backdrop-filter backdrop-blur-none bg-opacity-30">
      <h5 className="mb-3 text-base font-semibold text-gray-900 lg:text-xl dark:text-white">
        钱包
      </h5>
      <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
        当前网络:{items2.network ? items2.network : '未知'}
      </p>
      <p className="text-sm font-normal text-gray-500 dark:text-gray-400">
        余额:{items2.balance ? items2.balance + 'eth' : '未知'}
      </p>
      ...
      <ul className="my-4 space-y-3">
        <li>
          <a
            ...
            <span className="flex-1 ml-3 whitespace-nowrap text-orange-600">
              MetaMask
            </span>
            <p
